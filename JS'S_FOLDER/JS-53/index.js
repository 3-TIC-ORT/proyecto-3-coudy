document.querySelector('.siguiente').addEventListener('click', () => {
    ...
    let verificar = Number(localStorage.getItem('guardar-Level24-JS')) || 0;
    if (verificar === 1){
        window.location.href = '../JS-54/index.html';
    } else if (verificar === 0){
        if (input1 === 'while' && input2 === '<') {
            alert("Felicitaciones, has completado el Nivel 24!");
            localStorage.setItem('guardar-Level24-JS', 1);
            window.location.href = '../JS-54/index.html';
